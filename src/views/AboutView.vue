    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Codeigniter',
          imageUrl: 'https://cdn1.iconfinder.com/data/icons/logos-3/304/codeigniter-icon-1024.png',
          status: 'Intermediate'
        },
        {
          id: 7,
        ...
        },
        {
          id: 8,
          name: 'AlpineJS',
          imageUrl: 'https://avatars.githubusercontent.com/u/59030169?s=280&v=4',
          status: 'Beginner'
        },
        {
          id: 9,
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://tse4.mm.bing.net/th?id=OIP.hCTwF_0L-K4PaLQMI985oAHaHa&pid=Api&P=0&h=180" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is I Gusti Ngurah Satrya Wibawa. I'm a web developer from Denpasar, Bali. I
